Feature: Create a CSV file and write the data into it

    @csv
    Scenario: Creating a valid data for the pojo abcd with multiple datas
        When create a valid pojo for abcd having 100 count
        Then create that array of pojos as csv file

    @csv
    Scenario: creating a test data for the pojo abcd
        When create a pojo for <parameter> with <value> having <length>
        Then create that pojo as csv file
        Examples:
        ...
        @adminui @menu @MNU001MenuCreation @system @form @functional @negative @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU001MenuCreation @system @form @functional @smoke @notreviewed @superadmin @notupdated @notautomated
        Scenario: Verify user can able to create a new menu for Web by entering all the fields
                When User is on "Menu" page
                ...
                Then User should be able to create a new menu under Web
        ...
        @adminui @menu @MNU001MenuCreation @system @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU001MenuCreation @system @achievo @functional @negative @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU001MenuCreation @system @special @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU001MenuCreation @Intrgration @special @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU001MenuCreation @Integration @special @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU002MenuCreationAddmenu @Integration @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU002MenuCreationAddmenu @integration @form @functional @negative @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU002MenuCreationAddmenu @system @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU002MenuCreationAddmenu @system @form @functional @negative @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU003MenuCreationConfigureAudienceGroup @system @special @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU003MenuCreationConfigureAudienceGroup @system @special @functional @negative @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU003MenuCreationConfigureAudienceGroup @system @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU004MenuCreationLanguages @system @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU005GlobalAccessMenuCommonComponents @system @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU005GlobalAccessMenuCommonComponents @system @form @functional @negative @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU006GlobalAccessMenu @system @form @functional @positive @notreviewed @superadmin @notupdated @notautomated
        ...
        @adminui @menu @MNU006GlobalAccessMenu @system @form @functional @negative @notreviewed @superadmin @notupdated @notautomated
